...
<body class="vertical-layout vertical-menu-modern 1-column bg-secondary bg-full-screen-image blank-page"
    data-open="click" data-menu="vertical-menu-modern" data-col="1-column" style="background: url('<?php echo roothtml."lib/images/bg.jpg"; ?>') no-repeat center center fixed;
                ...
                <section class="row flexbox-container">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card glass-card border-grey border-lighten-3 px-1 py-1 m-0">
