    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">ဖြတ်ပိုင်းကြည့်ရန်</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=roothtml.'home/home.php'?>">Home</a>
                            </li>
                            <li class="breadcrumb-item active">ဖြတ်ပိုင်းကြည့်ရန်
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start"
                        ...
                        <form method="POST" action="donationview_action.php">
...
<script>
var donation_url = "<?php echo roothtml.'donation/donationview_action.php'; ?>";
...
$(document).ready(function() {
    ...
    $(document).on("click", "#btnedit", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 1) {
                    window.location.href = "<?= roothtml.'donation/donation.php'?>"
                } 
                else {
                    Swal.fire({
                        position: 'top-end',
