    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Manage Category</h3>
            ...
            <form id="frmsave" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" required class="form-control" name="categoryname" placeholder="Enter CategoryName">
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="frmedit" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="usr">Category Name</label>
                        <input type="text" required class="form-control" name="ecategoryname" placeholder="Enter CategoryName">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
...
<script>
var category_url = "<?php echo roothtml.'category/category_action.php'; ?>";
