    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">ပစ္စည်းစာရင်းသွင်းရန်</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=roothtml.'home/home.php'?>">Home</a>
                            </li>
                            <li class="breadcrumb-item active">ပစ္စည်းစာရင်းသွင်းရန်
                            </li>
                        </ol>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '#btninsert', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                location.href = "<?=roothtml.'category/store.php'?>";
            }
        });
    });
