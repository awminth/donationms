...
$action = $_POST['action'];
$usertype = (isset($_SESSION["donationms_usertype"])?$_SESSION["donationms_usertype"]:"Admin");
...
if($action == 'pdf'){
    ...
    if($usertype == "Agent"){
        $userid = GetString("SELECT AID FROM tbluser WHERE AgentID = ? ", [$_SESSION["donationms_agentid"]]);
